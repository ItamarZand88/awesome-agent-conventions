<!-- source: awesome-copilot-object-calisthenics — https://raw.githubusercontent.com/github/awesome-copilot/main/instructions/object-calisthenics.instructions.md -->
---
applyTo: '**/*.{cs,ts,java}'
